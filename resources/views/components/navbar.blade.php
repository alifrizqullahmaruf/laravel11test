<nav class="bg-gray-800">
    ...
    <div x-show="isOpen" x-cloak class="md:hidden" id="mobile-menu">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
            <x-navlinkapp href="/" :active="request()->is('/')">
                Home
            </x-navlinkapp>
            <x-navlinkapp href="/posts" :active="request()->is('posts')">
                Blog
            </x-navlinkapp>
            <x-navlinkapp href="/about" :active="request()->is('about')">
                About
            </x-navlinkapp>
            <x-navlinkapp href="/contact" :active="request()->is('contact')">
                Contact
            </x-navlinkapp>
        </div>
